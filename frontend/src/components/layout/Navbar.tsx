    ...
    return (
        <header className="fixed top-0 w-full z-50 glass border-b border-white/10">
                        ...
                        <NavigationMenu.Item className="flex items-center">
                            ...
                            <NavigationMenu.Content className="absolute top-full left-0 mt-2 p-4 glass rounded-2xl w-48 border border-border animate-in fade-in slide-in-from-top-2">
                                <ul className="flex flex-col gap-2">
                                    ...
                                    <li><Link href="#" className="block p-2 text-sm hover:bg-primary/10 rounded-lg">Giáo dục</Link></li>
                                </ul>
                            </NavigationMenu.Content>
                        </NavigationMenu.Item>

                        <NavigationMenu.Item className="flex items-center">
                            <Link href="#features" className="px-4 py-2 text-sm font-medium hover:text-primary transition-colors flex items-center h-full">
                                Tính năng
                            </Link>
                        </NavigationMenu.Item>

                        <NavigationMenu.Item className="flex items-center">
                            <Link href="#pricing" className="px-4 py-2 text-sm font-medium hover:text-primary transition-colors flex items-center h-full">
                                Bảng giá
                            </Link>
                        </NavigationMenu.Item>
            ...
            {isOpen && (
                ...
                >
                    <Link href="#" className="py-2 border-b border-border">Sản phẩm</Link>
