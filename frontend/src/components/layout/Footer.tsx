        ...
        <div className="grid md:grid-cols-4 gap-12 mb-20 px-4">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-8">
              Nền tảng chia sẻ và quản lý tệp tin an toàn nhất cho cá nhân và
              doanh nghiệp.
            </p>
            <div className="flex gap-4">
              <Link
                href="#"
                className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:bg-primary/10 hover:border-primary transition-colors hover:text-primary"
              >
