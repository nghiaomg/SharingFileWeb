        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4">
              Kết nối với <span className="text-primary">FileFlow</span>
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Bạn có câu hỏi hoặc cần tư vấn về gói doanh nghiệp? Đừng ngần ngại
              liên hệ để nhận sự hỗ trợ tận tình từ các chuyên gia của chúng
              tôi.
            </p>
          </div>
            ...
            <div className="md:col-span-2 bg-primary text-white p-10 flex flex-col justify-between">
              <div>
                ...
                <p className="text-primary-foreground/80 mb-12">
                  Chúng tôi sẽ tiếp nhận và phản hồi bạn trong thời gian sớm
                  nhất.
                </p>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 mt-1">
                        Tòa nhà FileFlow Tower, Quận 1, Tp. Hồ Chí Minh
                      </p>
                    </div>
                  </div>
                </div>
