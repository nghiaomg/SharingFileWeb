...
export const metadata: Metadata = {
  ...
  description:
    "Giải pháp lưu trữ và chia sẻ tệp tin hiện đại với quản lý phiên bản và bảo mật cao.",
};
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="py-24 px-4 container mx-auto text-center border-y border-border/50 bg-gradient-to-b from-transparent via-primary/5 to-transparent">
        ...
        <p className="text-muted-foreground mb-10 max-w-xl mx-auto">
          Tham gia cùng hàng nghìn người dùng đang tin dùng FileFlow để chia sẻ
          dữ liệu mỗi ngày.
        </p>
        <button className="px-10 py-4 bg-primary text-primary-foreground font-bold rounded-2xl hover:bg-primary/90 text-lg transition-colors border border-primary/40 hover:border-primary">
