  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="py-24 px-4 container mx-auto text-center border-y border-border/50 bg-gradient-to-b from-transparent via-primary/5 to-transparent">
        ...
        <button className="px-10 py-4 bg-primary text-white font-bold rounded-2xl hover:bg-primary/90 text-lg transition-colors border border-primary/40 hover:border-primary">
