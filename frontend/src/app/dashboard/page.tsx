...
const categoryIcons: Record<
  string,
  { icon: React.ElementType; colorName: string }
> = {
...
function getCategoryUIKey(type?: string): string {
  ...
  if (t.includes("document") || t.includes("tài liệu") || t.includes("pdf"))
    return "document";
  return "other";
}
  ...
  return (
    ...
    >
      ...
      <Box mb="6">
        ...
        <Text size="3" style={{ color: "var(--muted-foreground)" }}>
          Xem nhanh tình trạng lưu trữ và các hoạt động gần đây.
        </Text>
      </Box>
