...
function SuccessContent() {
  ...
  const [confettiLayers, setConfettiLayers] = useState<
    Array<{ bg: string; left: string; delay: string; duration: string }>
  >([]);
      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground text-base font-medium mb-6">
            Cảm ơn bạn đã tin tưởng FileFlow. Gói dịch vụ của bạn đã được kích
            hoạt.
          </p>
          ...
          >
            <Flex align="center" justify="center" gap="2" mb="2">
              ...
              <Text weight="bold" size="3" className="text-emerald-500">
                {planName}
              </Text>
            </Flex>
            ...
            {orderCode && (
              <Text
                size="1"
                className="text-muted-foreground font-mono mt-1 block"
              >
        ...
        >
          <Text size="2" className="text-muted-foreground font-medium">
            ...
            <strong className="text-foreground">hotro@fileflow.vn</strong> hoặc
            zalo: <strong className="text-foreground">FileFlow Support</strong>
          </Text>
        </Box>
      </Box>
