        ...
        <div className="flex flex-col gap-8 xl:col-span-1">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-2 text-sm text-muted-foreground font-medium">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500" /> Dung
                  lượng lưu trữ 500GB
                </div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground font-medium">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500" /> Upload
                  tệp lớn đến 10GB
                </div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground font-medium">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500" /> Băng
                  thông tải xuống tốc độ cao
                </div>
              </div>
          ...
          <div className="bg-card border border-border/50 rounded-3xl p-6 shadow-sm">
            ...
            <div className="mt-4 flex items-start gap-3 p-4 bg-amber-500/10 text-amber-600 rounded-xl text-xs font-medium border border-amber-500/20">
              ...
              <p>
                Chúng tôi sử dụng cổng thanh toán Stripe. Dữ liệu thẻ của bạn
                được mã hóa an toàn ở mức độ cao nhất và không được lưu trữ trên
                máy chủ của FileFlow.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-card border border-border/50 rounded-3xl p-6 md:p-8 shadow-sm h-full">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              <h3 className="text-xl font-bold flex items-center gap-2">
                <FileText className="w-6 h-6 text-foreground/70" /> Lịch sử
                thanh toán
              </h3>
              ...
              <table className="w-full min-w-[600px] text-left">
                <thead>
                  <tr className="border-b border-border/50 text-muted-foreground text-sm">
                    ...
                    <th className="font-semibold pb-4 text-right pr-4">
                      Hành động
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border/50">
                  {[
                    ...
                    },
                    {
                      ...
                      amount: "$49.99",
                      status: "Nâng cấp Gói",
                      statusColor: "text-zinc-900 dark:text-zinc-100",
                    ...
                    >
                      ...
                      <td className="py-5">
                        <span
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 ${invoice.statusBg} ${invoice.statusColor} rounded-md text-xs font-bold border border-current/10`}
                        >
                      ...
                      <td className="py-5 pr-4 text-right">
                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            className="p-2 text-muted-foreground hover:text-primary bg-background border border-border shadow-sm rounded-lg transition-colors cursor-pointer tooltip-trigger"
                            title="Chi tiết"
                          >
                            <ExternalLink className="w-4 h-4" />
                          </button>
                          <button
                            className="p-2 text-muted-foreground hover:text-emerald-500 bg-background border border-border shadow-sm rounded-lg transition-colors cursor-pointer tooltip-trigger"
                            title="Tải PDF"
                          >
            ...
            <div className="mt-8 pt-6 border-t border-border/50 flex items-center justify-between text-sm text-muted-foreground">
              <p>
                Đang hiển thị{" "}
                <span className="font-bold text-foreground">4</span> hóa đơn gần
                nhất.
              </p>
