      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="text-center mb-6 space-y-2">
            ...
            <h1 className="text-3xl md:text-3xl font-black text-foreground">
              Thanh toán đơn hàng
            </h1>
            <p className="text-muted-foreground max-w-lg mx-auto">
              Mở ứng dụng ngân hàng và quét mã QR bên dưới. Hệ thống sẽ xác nhận
              tự động.
            </p>
          </div>
          ...
          <div className="w-full flex flex-col lg:flex-row gap-8 items-center lg:items-start justify-center">
            ...
            <div className="flex-1 w-full max-w-md space-y-8 mt-4 lg:mt-0">
              <div className="space-y-6">
                <Box>
                  <Text
                    color="gray"
                    size="2"
                    className="uppercase tracking-wider font-bold mb-1 block"
                  >
                    Dịch vụ đang đăng ký
                  </Text>
                  <Text weight="bold" size="5" className="text-foreground">
                ...
                <Box>
                  <Text
                    color="gray"
                    size="2"
                    className="uppercase tracking-wider font-bold mb-2 block"
                  >
                  ...
                  <Flex align="center" gap="3">
                    <Badge
                      ...
                      size="3"
                      variant="soft"
                      className="font-mono tracking-widest font-black text-lg px-4 py-2"
                    >
                    ...
                    <Button
                      ...
                      size="3"
                      onClick={() =>
                        handleCopy(`FL ${paymentStatus.orderCode}`)
                      }
                  ...
                  <p className="text-xs text-muted-foreground mt-2 italic">
                    * Vui lòng nhập chính xác nội dung chuyển khoản để được xác
                    nhận tự động.
                  </p>
                </Box>
              </div>
              ...
              <Flex
                align="center"
                gap="3"
                className="text-sm font-medium text-emerald-600 bg-emerald-50/50 p-4 rounded-2xl border border-emerald-100"
              >
                <ShieldCheck className="w-6 h-6 shrink-0" />
                <p>
                  Giao dịch được mã hóa an toàn bằng chuẩn AES-256. Không lưu
                  trữ thông tin thẻ.
                </p>
              </Flex>
            </div>
