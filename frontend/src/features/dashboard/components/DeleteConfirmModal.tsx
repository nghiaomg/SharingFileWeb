        ...
        <Dialog.Root open={isOpen} onOpenChange={(open) => {
            ...
            <Dialog.Content maxWidth="450px">
                ...
                <Dialog.Description size="2" mb="4">
                    Bạn có chắc chắn muốn bỏ <Text weight="bold">{name}</Text> vào thùng rác không?
                    <br />
                    <Text color="gray" size="1">Dữ liệu có thể được khôi phục hoặc xóa vĩnh viễn trong thùng rác sau 30 ngày.</Text>
                </Dialog.Description>
                ...
                <Flex gap="3" justify="end">
                    ...
                    <Button color="red" onClick={handleConfirm} disabled={isLoading} loading={isLoading}>
                        Bỏ vào thùng rác
                    </Button>
                </Flex>
            </Dialog.Content>
