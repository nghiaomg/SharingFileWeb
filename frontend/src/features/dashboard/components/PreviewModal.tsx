          ...
          <Dialog.Title style={{ margin: 0 }}>
            <Flex align="center" gap="2">
              ...
              {itemType === "unknown" && (
                <Eye
                  className="w-5 h-5"
                  style={{ color: "var(--icon-indigo)" }}
                />
              )}
              <Text truncate style={{ color: "var(--color-foreground)" }}>
                Xem trước: {itemName}
              </Text>
            </Flex>
          </Dialog.Title>
          ...
          {isLoading || (itemType === "xlsx" && sheetLoading) ? (
                ...
                <Table.Root variant="surface">
                  <Table.Header>
                    {sheetData[0] && (
                      <Table.Row>
                        {sheetData[0].map(
                          (col: string | number, index: number) => (
            ...
            >
              <Eye
                ...
                style={{ opacity: 0.2, color: "var(--muted-foreground)" }}
              />
              <Text
                size="4"
                weight="bold"
              ...
              <Text style={{ maxWidth: 400, color: "var(--muted-foreground)" }}>
                Vui lòng tải xuống tệp để xem định dạng này. Tính năng xem trước
                hỗ trợ tệp PDF, bảng tính Excel, và Thư mục.
              </Text>
            </Flex>
          )}
        </Box>
