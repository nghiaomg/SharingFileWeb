  ...
  return (
    <main className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="flex flex-col items-center justify-center p-8 lg:p-16 relative">
        ...
        <Link
          href="/"
          className="absolute top-8 left-8 sm:top-12 sm:left-12 flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors group"
        >
      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-muted/30 border-l border-border p-12 relative overflow-hidden hero-gradient">
        ...
        <div className="max-w-xl text-center z-10 w-full">
          <h2 className="text-3xl font-bold mb-6 text-foreground/80">
            Quản lý tệp tin an toàn chưa bao giờ dễ dàng như thế.
          </h2>
          <p className="text-lg text-muted-foreground mb-12">
            Tham gia ngay hôm nay để nhận 1GB lưu trữ miễn phí, hoặc nâng cấp
            lên gói cao cấp cho doanh nghiệp. Hỗ trợ đầy đủ các định dạng, chia
            sẻ nhanh bằng liên kết hoặc mã PIN an toàn.
          </p>
          ...
          <div className="relative w-full h-[380px] mt-8">
            ...
            <div
              className="absolute top-2 right-0 w-48 p-3 rounded-2xl glass border border-white/20 bg-card/80 backdrop-blur-xl animate-float"
            ...
            <div
              className="absolute bottom-16 -left-4 w-56 p-4 rounded-2xl glass border border-white/20 bg-card/80 backdrop-blur-xl animate-float"
