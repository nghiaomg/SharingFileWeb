  ...
  monthly: [
    {
      ...
      features: [
        "Tải lên tệp tối đa 25MB",
        "1GB lưu trữ đám mây",
        "Chia sẻ liên kết cơ bản",
        "Hỗ trợ cộng đồng",
      ],
    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            Chúng tôi cung cấp các gói linh hoạt từ cá nhân đến doanh nghiệp
            lớn.
          </motion.p>
        </div>
...
function PricingCard({
  ...
  return (
    <div
      className={`relative p-8 rounded-[2rem] border transition-all duration-300 flex flex-col h-full bg-card hover:border-primary/60 ${
