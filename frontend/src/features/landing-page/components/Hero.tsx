        ...
        >
          <div className="max-w-xl text-center lg:text-left mx-auto lg:mx-0">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/20 bg-primary/5 text-primary text-xs font-semibold mb-6 tracking-wide uppercase"
            >
            ...
            <motion.h1
              variants={itemVariants}
              className="text-5xl md:text-6xl font-extrabold mb-6 leading-[1.1] tracking-tight text-foreground"
            >
              Giải pháp lưu trữ &{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-zinc-500 to-indigo-500">
                Chia sẻ tệp tin
              </span>{" "}
              thế hệ mới
            </motion.h1>
            ...
            >
              Tải lên, cập nhật phiên bản và chia sẻ tệp tin của bạn chỉ trong
              vài giây. Bảo mật tuyệt đối với mã hóa đầu cuối và hệ thống quản
              lý quyền truy cập thông minh.
            </motion.p>
            ...
            >
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  ...
                  >
                    <div
                      className={`w-full h-full bg-gradient-to-tr from-primary/40 to-zinc-400 group-hover:scale-110 transition-transform`}
                    />
                  </div>
                ))}
              </div>
            ...
            <div className="relative z-10 w-full h-[500px] mt-10 rounded-[2.5rem] overflow-hidden glass border border-white/20 animate-float bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl flex flex-col items-center justify-center p-8">
              ...
              <div className="w-full h-full rounded-3xl border-2 border-dashed border-primary/40 bg-primary/5 flex flex-col items-center justify-center relative overflow-hidden group hover:bg-primary/10 transition-colors duration-500">
                ...
                <p className="text-muted-foreground text-center px-4 max-w-sm">
                  Hỗ trợ tải lên siêu tốc với mã hóa đầu cuối. <br /> Kích thước
                  tối đa:{" "}
                  <span className="font-semibold text-foreground">50GB</span>
                </p>
