        ...
        if (showDirectActions) {
            return (
                <Flex align="center" gap="1">
                    {onDownload && (
                        <IconButton variant="ghost" color="gray" onClick={(e) => { e.stopPropagation(); onDownload(file); }}>
                            <Download className="w-5 h-5" />
                        </IconButton>
                    )}
                    {onShare && (
                        <IconButton variant="ghost" color="gray" onClick={(e) => { e.stopPropagation(); onShare(file); }}>
            ...
            return (
                <DropdownMenu.Root>
                    ...
                    <DropdownMenu.Content size="2" variant="solid" align="end">
                        {onDownload && (
                            <DropdownMenu.Item onClick={(e) => { e.stopPropagation(); onDownload(file); }} className="cursor-pointer">
                        ...
                        {onDelete && (
                            <DropdownMenu.Item color="red" onClick={(e) => { e.stopPropagation(); onDelete(file); }} className="cursor-pointer">
