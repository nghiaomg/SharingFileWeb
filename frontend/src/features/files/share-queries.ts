...
import { getSharedWithMe, getSharedByMe, getAccessesForFile, getShareLinksForFile, getNotifications, getUnreadNotificationCount, getSharedFolderContent } from "./api";
...
export const shareKeys = {
    ...
    fileAccesses: (fileId: string) => [...shareKeys.all(), "accesses", fileId] as const,
    fileLinks:    (fileId: string) => [...shareKeys.all(), "links", fileId] as const,
    sharedFolderContent: (accessId: string) => [...shareKeys.all(), "folder-content", accessId] as const,
