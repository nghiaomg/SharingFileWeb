    ...
    <div>
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: 24 }}>
        <Col xs={24} sm={12} lg={6}>
          <StatCard title="Total" value={stats.total} icon={<FileTextOutlined style={{ color: '#1677ff' }} />} />
        </Col>
        <Col xs={24} sm={12} lg={6}>
          <StatCard title="Active" value={stats.active} icon={<CheckCircleOutlined style={{ color: '#52c41a' }} />} />
        </Col>
        <Col xs={24} sm={12} lg={6}>
          <StatCard title="Trash" value={stats.deleted} icon={<DeleteOutlined style={{ color: '#ff4d4f' }} />} />
        </Col>
        <Col xs={24} sm={12} lg={6}>
          <StatCard title="Storage Used" value={parseFloat(formatBytes(stats.totalSize).split(' ')[0])} trend={formatBytes(stats.totalSize).split(' ')[1]} icon={<ExclamationCircleOutlined style={{ color: '#faad14' }} />} />
        </Col>
      </Row>
